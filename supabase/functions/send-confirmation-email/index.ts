...
<title>Booking Confirmed - D’FORTEES</title>
</head>
  ...
  <tr><td align="center">
    <table width="560" cellpadding="0" cellspacing="0" style="background:#202428;background-image:linear-gradient(#202428,#202428);border:1px solid #323840;border-radius:14px;overflow:hidden;box-shadow:0 12px 34px rgba(0,0,0,.42);max-width:560px;width:100%;">
      ...
      <tr><td style="background:#75330f;background-image:linear-gradient(#75330f,#75330f);padding:34px 36px 30px;text-align:center;border-top:6px solid #f59a38;border-bottom:1px solid #8f4518;">
        ${LOGO_URL ? `<img src="${LOGO_URL}" width="96" height="96" alt="D’fortees Pickleball Court logo" style="display:block;width:96px;height:96px;margin:0 auto 14px;border-radius:24px;background:#fff;padding:6px;border:4px solid #0f1720;"/>` : ""}
        <div style="font-family:'Bebas Neue',Georgia,serif;font-size:1.6rem;letter-spacing:3px;color:#1b1f24;line-height:1.1;font-weight:900;">D’FORTEES</div>
        <div style="font-size:.75rem;color:#2c221b;letter-spacing:1px;text-transform:uppercase;margin-top:4px;font-weight:700;">Prk-4 National Highway, 8801 Montevista</div>
      </td></tr>
      ...
      <tr><td style="padding:32px 36px;background:#202428;background-image:linear-gradient(#202428,#202428);">
        ...
        <p style="margin:0 0 24px;font-size:.95rem;color:#d7dee8;line-height:1.6;">
          Great news! D’FORTEES booking has been <strong style="color:#f49a4a;">confirmed</strong>.
      ...
      <tr><td style="background:#1b2025;background-image:linear-gradient(#1b2025,#1b2025);padding:18px 36px;text-align:center;border-top:1px solid #30363d;">
        <div style="font-size:.75rem;color:#f49a4a;letter-spacing:1px;">D’FORTEES</div>
