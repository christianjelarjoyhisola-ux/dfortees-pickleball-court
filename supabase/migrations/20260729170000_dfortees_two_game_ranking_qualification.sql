-- D'fortees uses two completed games as a practical official-ranking
-- threshold while keeping zero- and one-game players provisional.
...
comment on column public.open_play_game_sessions.performance_rating_min_games is
  'Minimum completed games required for an official D''fortees session rank.';
