...
// Sets up the full D’fortees Pickleball Court schema in the new Supabase project
...
const SUPABASE_URL = env.SUPABASE_URL || 'https://dfortees-backend.invalid';
...
async function run() {
  ...
  // â”€â”€ 1. CREATE TABLES â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
  const tables = [
    {
      name: 'courts',
  ...
  for (const t of tables) {
    ...
    // rpc exec_sql won't exist on fresh project â€” use REST SQL endpoint instead
    await runSQL(t.sql, t.name);
  }

  // â”€â”€ 2. INDEXES â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
  const indexes = [
  ...
  // â”€â”€ 3. TRIGGERS â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
  await runSQL(`
  ...
  // â”€â”€ 4. RLS â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
  const rlsStatements = `
  ...
  // â”€â”€ 5. RLS POLICIES â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
  const policies = [
    // bookings
  ...
  // â”€â”€ 6. SEED DATA â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
  const { error: courtErr } = await sb.from('courts').upsert([
    { id: 'c1', name: 'Court Alpha', description: 'Outdoor Â· Open Air Â· Standard Flooring', rate: 350, blocked: false, feats: ['Outdoor','Open Air','Standard Floor'] },
    { id: 'c2', name: 'Court Beta',  description: 'Outdoor Â· Open Air Â· Standard Flooring', rate: 280, blocked: false, feats: ['Outdoor','Open Air','Standard Floor'] },
  ], { onConflict: 'id' });
  console.log(courtErr ? `  âœ— seed courts: ${courtErr.message}` : '  âœ“ seed courts');

  const { error: settErr } = await sb.from('settings').upsert([
    { key: 'venue_name',    value: 'D’fortees Pickleball Court' },
    { key: 'open_time',     value: '6' },
    { key: 'close_time',    value: '22' },
    { key: 'booking_fee',   value: '5' },
    { key: 'open_play_fee', value: '100' },
  ], { onConflict: 'key' });
  console.log(settErr ? `  âœ— seed settings: ${settErr.message}` : '  âœ“ seed settings');

  console.log('\nDone!');
}

async function runSQL(sql, label) {
  // Use Supabase's pg REST endpoint via RPC â€” only works with service_role
  ...
  if (r.ok) {
    ...
    console.log(`  âœ— ${label} (${r.status}): ${body.substring(0, 120)}`);
  }
}
